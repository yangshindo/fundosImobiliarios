...
function FundosContextProvider(props) {
  const [fundosDBList, setFundosDBList] = useState([
    ...
    { id: 2, title: "CPTS11", rendimento: 1.10, recebido: 1.10, cotas: 1, pago: 1, mes1: 0.2, mes2: 0.2, mes3: 0.2, mes4: 0.3, mes5: 0.1, mes6: 0.4 },
    { id: 3, title: "HGRU11", rendimento: 0.82, recebido: 1.64, cotas: 2, pago: 0.4, mes1: 0.7, mes2: 0.2, mes3: 0.9, mes4: 2.3, mes5: 2, mes6: 1.4  },
  ]);
